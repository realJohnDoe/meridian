...
Hypotheses to verify or refute. The report must state a verdict on each (confirmed / refuted / couldn't verify), backed by a repro where possible. A refutation is as valid an outcome as a confirmation.
