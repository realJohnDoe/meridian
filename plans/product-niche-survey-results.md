...
**Sequencing note.** #3 is a positioning decision. #4's copy half waits on #3, since who the visual identity should address depends on whether the line-7 persona survives.
