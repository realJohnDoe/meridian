...
7. **UI Toolchain & Feedback Loops** — findings: #6, #7. The enabled
...
**Sequencing.** #6 and #7 together (both edit `vitest.config.ts`). #8 is
independent of everything, and so is #1.
