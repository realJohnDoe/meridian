...
5. Flat components/ directory spanning five unrelated domains
   Category: layout
   Impact: 5
...
6. Every view re-runs full expansion; fileOccurrenceMap expands ±3 years
...
7. Three sources of truth for a task's done state, including prop mutation
...
8. Editor field shape redefined three times with manual remapping
   Category: dry naming
   Impact: 5
...
9. Recurrence-interval logic duplicated between dialog and engine
   Category: dry srp
   Impact: 4
...
10. Persistence is fire-and-forget; UI confirms saves before they happen
...
11. GitHub PAT stored in plaintext IndexedDB
    Category: security
    Impact: 4
...
12. Vault registry update ritual duplicated four times
    Category: dry
    Impact: 3
...
13. Identical dedupe/sort block copy-pasted in the expansion API
    Category: dry
    Impact: 3
...
14. Notification system implemented twice end-to-end
    Category: dry ux
    Impact: 3
...
15. Date primitives re-implemented in three modules
    Category: dry
    Impact: 3
...
16. MonthView filters all month occurrences once per cell
    Category: performance
    Impact: 3
...
17. Storage-layer names still describe the local-disk era
    Category: naming
    Impact: 2
...
18. Dead code at module boundaries
    Category: dead-code
    Impact: 2
...
19. Unbounded module-level caches in the model layer
