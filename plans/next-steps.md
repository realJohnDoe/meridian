...
2. Horizontal swipe-navigation gesture duplicated in DayView and MonthView
   Impact: Medium
...
3. fileOccurrenceMap runs two ±3-year expansions on the navigation path
   Impact: Medium
...
4. Cache-write failures are silently swallowed
   Impact: High
