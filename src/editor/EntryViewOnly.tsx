...
export default function EntryViewOnly({ occ, vault, items, roots }: Props) {
  ...
  return (
    <section className="flex-1 min-h-0 flex flex-col" data-shell-pane>
      <div className="flex-1 overflow-y-auto [-webkit-overflow-scrolling:touch]" data-shell-pane><div className="px-3.5 pt-4.5 pb-30 lg:max-w-3xl lg:mx-auto">
