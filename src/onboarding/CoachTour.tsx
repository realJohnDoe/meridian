  ...
  const steps = useMemo<Step[]>(() => [
    {
      ...
      body: 'Meridian keeps your tasks, events, and notes as plain Markdown files in a folder — called a vault — that you own. Here\'s a quick look at where things live.',
      before: async () => {
    ...
    {
      title: 'The menu',
      body: 'Open the menu to switch between Agenda, Month, Week, and Day, and manage vaults in Settings. That\'s it — explore freely.',
      before: async () => {
        navigateHome()
        setSidebarOpen(true)
        await sleep(350)
