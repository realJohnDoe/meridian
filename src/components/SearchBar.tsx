...
export default function SearchBar() {
  ...
  return (
    <div className="shrink-0 relative z-30 pointer-events-none">
      ...
      <div className={cn('relative z-[26] px-3.5 pt-3.5 pb-[max(14px,env(safe-area-inset-bottom))] flex flex-col gap-2', searchOpen ? 'bg-background' : 'bg-background/85 backdrop-blur-sm')}>
