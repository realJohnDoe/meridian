...
const Checkbox = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof CheckboxPrimitive.Root> & { visualClassName?: string }
>(({ className, visualClassName, ...props }, ref) => (
  ...
  >
    <span className={cn(
      'size-5 rounded-full border-[1.5px] border-surface-raised flex items-center justify-center',
