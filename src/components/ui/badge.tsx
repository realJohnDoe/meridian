  ...
  'inline-flex items-center gap-1.5 border font-medium whitespace-nowrap transition-colors',
  {
    variants: {
      variant: {
        ...
        // bg-primary/30 (a tint, not a solid fill) reads as an accent rather than a
        ...
        link: 'px-1.5 py-0.5 text-2xs rounded-lg border-[var(--chip-border)] bg-primary/30 text-chip-tint-foreground',
        ...
        chip: [
          ...
          'aria-[pressed=true]:bg-primary/30 aria-[pressed=true]:text-chip-tint-foreground aria-[pressed=true]:border-primary',
          'data-[state=on]:bg-primary/30 data-[state=on]:text-chip-tint-foreground data-[state=on]:border-primary',
        ],
      },
    },
