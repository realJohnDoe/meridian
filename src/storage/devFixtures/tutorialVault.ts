// Tutorial vault content — the Markdown+frontmatter fixtures served by
// ExampleBackend. Split out from exampleBackend.ts so editing onboarding
// copy doesn't mean editing a StorageBackend implementation; see
// exampleBackend.ts for the adapter that serves this content.
...
export function buildEntries(): Array<{ id: string; content: string }> {
