...
export type { StoreData, EditorFields, EditFields, SeriesContext, NewEntryTarget } from './storeOps'
export { entryKeyItems, findSeries, seriesContext, upsertOverride, applyEdit, newEntryKey, toggleDone, excludeOccurrence, deletionEndsAfterCompletionSeries, deleteByEntryKey, deleteFollowing, occFromAppMeta } from './storeOps'
