...
export { fileSlugItems, findSeries, upsertOverride, applyEdit, toggleDone, excludeOccurrence, deletionEndsAfterCompletionSeries, deleteByFileSlug, deleteFollowing, updateRoot } from './storeOps'
...
export { hasSameStructure, computeExpansionCache } from './expansionCache'
